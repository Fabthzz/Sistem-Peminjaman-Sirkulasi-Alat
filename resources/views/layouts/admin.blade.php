...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        body { font-family: 'Plus Jakarta Sans', sans-serif; background: var(--bg); color: var(--primary); min-height: 100vh; }
        ...
        .brand-sub { font-size: 10px; color: rgba(255,255,255,0.5); font-weight: 500; }
        ...
        .nav-item a.active { background: var(--orange); color: white; }
        .nav-item a i { font-size: 16px; }

        .sidebar-footer { padding: 12px; border-top: 1px solid rgba(255,255,255,0.08); }
        .btn-logout {
            width: 100%; background: rgba(239,68,68,0.15); color: #fca5a5;
        ...
        /* CARDS */
        .card-spsa { background: var(--white); border-radius: var(--radius); box-shadow: var(--card-shadow); border: 1px solid #e2e8f0; overflow: hidden; }
        .card-header-spsa { padding: 18px 22px; border-bottom: 1px solid #f1f5f9; display: flex; align-items: center; justify-content: space-between; }
        .card-header-spsa h5 { font-size: 15px; font-weight: 700; margin: 0; }

        /* STAT */
        .stat-card { background: var(--white); border-radius: var(--radius); box-shadow: var(--card-shadow); padding: 20px; display: flex; align-items: center; gap: 16px; border: 1px solid #e2e8f0; }
        ...
        .table-spsa thead th { background: #f8fafc; padding: 12px 16px; font-size: 12px; font-weight: 700; text-transform: uppercase; letter-spacing: .5px; color: var(--muted); border-bottom: 2px solid #e2e8f0; text-align: left; }
        .table-spsa tbody tr { border-bottom: 1px solid #f1f5f9; transition: background .15s; }
        .table-spsa tbody tr:hover { background: #f8fafc; }
