                        ...
                        <div style="display:flex; align-items:center; gap:6px;">
                            ...
                            <form action="{{ route('admin.alat.update', $item->id) }}" method="POST"
                                ...
                                <input type="number" name="stok"
                                    value="{{ $item->stok }}"
                                    min="0"
                                    style="width:65px; border:1.5px solid #e2e8f0; border-radius:6px; padding:4px 6px; text-align:center; font-size:12px;">

                                <button type="submit"
                                    style="background:#dcfce7; color:#166534; border:none; padding:5px 10px; border-radius:6px; font-size:12px; cursor:pointer;">
                                    Update
                                </button>
                            </form>
                            ...
                            <form action="{{ route('admin.alat.destroy', $item->id) }}" method="POST"
                                ...
                                <button type="submit"
                                    style="background:#fee2e2; color:#991b1b; border:none; padding:5px 10px; border-radius:6px; font-size:12px; cursor:pointer;">
